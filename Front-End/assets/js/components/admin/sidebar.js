                ...
                <div class="row">
                    <div class="left">
                        ...
                        <ul class="sidebar">
                            ...
                            <li class="${currentView === 'users' ? 'active' : ''}">
                                <a href="./users.html" data-target="usuarios">Modulo Usuarios</a>
                            </li>

                            <li class="${currentView === 'news' ? 'active' : ''}">
                                <a href="./news.html" data-target="noticias">Modulo Noticias</a>
                            </li>

                            <li class="${currentView === 'notices' ? 'active' : ''}">
                                <a href="./notices.html" data-target="avisos">Modulo Avisos</a>
                            </li>

                            <li class="${currentView === 'initiatives' ? 'active' : ''}">
                                <a href="./initiatives.html" data-target="iniciativas">Modulo Iniciativas</a>
                            </li>
